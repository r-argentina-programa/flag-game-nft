<script>
	...
	import { keyPair, player, round, isConnected } from '../stores/main';
	...
	<header class="flags-nft-game w3-container" style="padding-top:22px">
		<div class="flags-nft-game w3-center">
			<div class="flags-nft-game header">
				<button class="flags-nft-game disconnect-btn" on:click={disconnectPlayer}>Disconnect</button
				>
